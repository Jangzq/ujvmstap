...
stap -v -D MAXTRACE=100 -D MAXSTRINGLEN=512 -D MAXMAPENTRIES=100  $STAP_LIB -D MAXACTION=20000 -D STP_OVERLOAD_THRESHOLD=5000000000 --all-modules jstackflame.stap -x $1 > out.stap-stacks
